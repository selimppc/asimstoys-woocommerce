...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-thumbnail">
		<?php if(get_post_meta(get_the_ID(), "decorpi_thumbnail_video_url", true) !== ""){ ?>
			<div class="blog-video-holder">
				<?php
				$videolink = get_post_meta(get_the_ID(), "decorpi_thumbnail_video_url", true);
	...
	<div class="post-content">
		...
		<div class="entry-content">
			<?php if(is_single()){
				the_content( sprintf(
					__( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'decorpi' ),
